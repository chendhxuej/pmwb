  ...
  <div class="page-container">
    ...
    <el-dialog v-model="basicVisible" :title="basicIsEdit ? '编辑基本信息' : '新建重点工作'" width="640px">
      <el-form :model="basicForm" label-width="100px">
        ...
        <el-form-item label="进度">
          <el-slider v-model="basicForm.progress" :min="0" :max="100" show-input :format-tooltip="(v) => v + '%'" />
        </el-form-item>
    ...
    <el-dialog v-model="memberVisible" title="团队成员" width="480px">
      <el-form :model="memberForm" label-width="80px">
        ...
        <el-form-item label="分工"><EnlargeInput v-model="memberForm.division_desc" type="textarea" :rows="2" /></el-form-item>
      </el-form>
      <template #footer>
...
function blankMain() {
  return {
    ...
    progress: 0, planned_finish_date: '', background: '', current_status: '', content: '',
  }
}
...
function openBasicEdit() {
  ...
  basicForm.value = {
    ...
    status: d.status, progress: d.progress || 0, planned_finish_date: d.planned_finish_date || '',
