    ...
    >
      <div v-loading="detailLoading" class="drawer-body-inner">
        ...
        <div class="dt-sec">
          ...
          <EmailSuperviseLog ref-type="operation" :ref-id="detailRow?.issue_no" :key="emailLogKey" />
        </div>
      </div>
      <template #footer>
...
// T-D：supervise_urge/sync 模板变量（no/title/category/handler/resolveDate/status/description）
