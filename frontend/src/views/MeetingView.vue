  ...
  <div class="meeting-view">
    ...
    <div class="bento-grid kpi-strip">
      <div class="card kpi-card">
        <div class="kpi-num blue" v-countup="weekCount"></div>
        <div class="kpi-label">本周会议</div>
      </div>
      <div class="card kpi-card">
        <div class="kpi-num amber" v-countup="plannedCount"></div>
        <div class="kpi-label">待开会议</div>
      </div>
      <div class="card kpi-card">
        <div class="kpi-num green" v-countup="mineCount"></div>
        <div class="kpi-label">我参与</div>
      </div>
      <div class="card kpi-card">
        <div class="kpi-num" v-countup="noteCount"></div>
      ...
      <div class="card span-12">
        <div class="card-header list-head">
          ...
          <div class="list-filters">
            <el-select v-model="filterType" placeholder="全部类型" clearable class="w-s">
              <el-option
            ...
            <el-select v-model="filterStatus" placeholder="全部状态" clearable class="w-s">
              <el-option
          ...
          <div v-for="(act, i) in detailMeeting.actions" :key="i" class="act-card">
            <div class="act-head">
              ...
              <div class="act-head-ops">
                <el-select v-model="act.status" placeholder="状态" size="small" class="w-xs">
                  <el-option
